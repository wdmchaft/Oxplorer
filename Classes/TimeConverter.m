...
+(NSString*)convert:(NSString*)input{
	input=[NSString stringWithFormat:@"%@ -0200",input];
	//TEST MODE
	//input=@"Sun, 24 Apr 2011 14:03:21 +0700";
	//Siva input = 2012-03-07T18:06:35.502Z
	NSString *result=@"";
	...
	if (difMin<1) result=@"Just now";	 
	else if (difMin<60) result=[NSString stringWithFormat:@"%@ minute%@ ago",difMin>1?[NSString stringWithFormat:@"%d",difMin]:@"A",difMin>1?@"s":@""];		 
